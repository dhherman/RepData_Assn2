...
```{r transintervals,echo=TRUE,cache=TRUE}
...
```{r histogram,fig.height=3.5,fig.width=6,echo=TRUE,cache=TRUE}
...
```{r meanmedsteps,echo=TRUE,cache=TRUE}
...
```{r avgdailypat,echo=TRUE,fig.height=3.5,cache=TRUE}
activity.avginter <- 
...
```{r maxavgsteps,echo=TRUE,cache=TRUE}
...
```{r histoimp,fig.height=3.5,fig.width=6,echo=TRUE,cache=TRUE}
...
```{r impmean,echo=TRUE,cache=TRUE}
...
``` {r extrfact,echo=TRUE,cache=TRUE}
...
``` {r newfactadd,echo=TRUE,cache=TRUE}
...
``` {r bonusplot,fig.height=3,fig.width=10,echo=TRUE,cache=TRUE}
